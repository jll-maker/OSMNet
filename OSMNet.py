...
from MultFca_Module import MultFcaLayer
...
class BasicBlock_Att(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.se = MultFcaLayer(out_channels, reduction=4)
...
class SSLCNetPseudo_Att(nn.Module):
    """SSLCNetPseudo model definition
    """
    def __init__(self):
        super(SSLCNetPseudo_Att, self).__init__()
        self.ResNet_Opt = SSLCNet(BasicBlock_Att, [1, 1, 1, 1])
        self.ResNet_Sar = SSLCNet(BasicBlock_Att, [1, 1, 1, 1])
